...
namespace CustomDatabase2.WebApp.Sharding.Controllers
{
    public class RolesController : Controller
    {
        ...
        [HasPermission(CustomDatabase2Permissions.RoleRead)]
        ...
        [HasPermission(CustomDatabase2Permissions.PermissionRead)]
        ...
        [HasPermission(CustomDatabase2Permissions.RoleChange)]
